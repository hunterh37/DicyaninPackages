...
public enum DicyaninSpatialUI {
    ...
    public static func register() {
        ...
        SpatialToggleComponent.registerComponent()
        SpatialSegmentedControlComponent.registerComponent()
        SpatialProgressBarComponent.registerComponent()
        SpatialDialComponent.registerComponent()
        SpatialStepperComponent.registerComponent()
        SpatialDropdownComponent.registerComponent()
        ...
        ToggleSystem.registerSystem()
        SegmentedControlSystem.registerSystem()
        ProgressBarSystem.registerSystem()
        DialSystem.registerSystem()
        StepperSystem.registerSystem()
        DropdownSystem.registerSystem()
    }
}
